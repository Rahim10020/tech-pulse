            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="h5-title text-gray-900">
                  {stats.mostUsed
                    ? `${stats.mostUsed.name} (${stats.mostUsed.count})`
                    : "Aucune"}
                </p>
              </div>
                ...
                <div className="grid grid-cols-5 gap-2">
                  {colorOptions.map((colorOption) => (
                    <button
                      ...
                      className={`p-3 rounded-lg border-2 transition-colors ${colorOption.bg} ${colorOption.text} ${
                        modalData.color === colorOption.bg
                          ? "border-gray-900"
                          : "border-gray-200 hover:border-gray-300"
                      }`}
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    <div
                      className={`${modalData.color} ${modalData.textColor} p-2 rounded-lg`}
                    >
