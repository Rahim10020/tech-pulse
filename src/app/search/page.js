...
export default function SearchPage() {
  ...
  const performSearch = useCallback(
    async (searchQuery = debouncedQuery, page = 1) => {
      if (!searchQuery.trim()) {
          ...
          {showFilters && (
            <div className="mt-6 p-6 bg-white border border-gray-200 rounded-xl">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                  <label className="h6-title text-gray-700 mb-2">
                    Trier par
                  </label>
                  <select
      ...
      <div className="flex items-start space-x-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="small-text text-gray-500">{article.readTime}</span>
          </div>
          ...
          <p
            className="body-text text-gray-600 mb-3 line-clamp-2"
            dangerouslySetInnerHTML={{
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md transition-shadow">
      <div className="text-center">
        ...
        <p
          className="small-text text-gray-600 mb-3"
          dangerouslySetInnerHTML={{
            __html: highlightText(author.bio || "", query),
          }}
        />

        <div className="small-text text-gray-500">
          {author.articlesCount || 0} article
          {(author.articlesCount || 0) !== 1 ? "s" : ""}
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md transition-shadow">
      <div className="text-center">
        ...
        <p
          className="small-text text-gray-600 mb-3"
          dangerouslySetInnerHTML={{
            __html: highlightText(category.description || "", query),
          }}
        />

        <div className="small-text text-gray-500">
          {category.articlesCount || 0} article
          {(category.articlesCount || 0) !== 1 ? "s" : ""}
        </div>
      </div>
    </div>
  );
